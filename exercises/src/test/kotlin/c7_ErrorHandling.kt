...
//        val heartBeat: Flux<String> = probeHeartBeatSignal() //todo: do your changes here
//        //todo: & here
...
//    @Test
//    fun potato_potato() {
//        val currentUser: Mono<String> = getCurrentUser() //todo: change this line only
...
//    @Test
//    fun under_the_rug() {
//        val messages: Flux<String> = messageNode()
...
//    @Test
//    fun unit_of_work() {
//        val taskFlux: Flux<Task> = taskQueue() //todo: do your changes here
...
//        val content: Flux<String> = getFilesContent()
...
//    @Test
//    fun its_hot_in_here() {
//        val temperature: Mono<Integer> = temperatureSensor() //todo: change this line only
...
//    @Test
//    fun back_off() {
//        val connection_result: Mono<String> = establishConnection() //todo: change this line only
