...
//        val requests: CopyOnWriteArrayList<Long> = CopyOnWriteArrayList()
...
//    @Test
//    fun uuid_generator() {
//        val uuidGenerator: Flux<UUID> = Flux.create { sink -> }
//        StepVerifier.create(
//            uuidGenerator
//                .doOnNext(System.out::println)
//                .timeout(Duration.ofSeconds(1))
//                .onErrorResume(TimeoutException::class.java) { e -> Flux.empty() },
...
//    fun subscriber() {
//        val lockRef: AtomicReference<CountDownLatch> = AtomicReference(CountDownLatch(1))
//        val count = AtomicInteger(0)
//        val sub: AtomicReference<Subscription> = AtomicReference()
...
//                @Override
//                protected fun hookOnSubscribe(subscription: Subscription?) {
//                    sub.set(subscription)
//                }
//
//                @Override
//                protected fun hookOnNext(s: String?) {
