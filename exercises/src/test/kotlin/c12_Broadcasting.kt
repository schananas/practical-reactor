...
//        val messages: Flux<Message> = messageStream() //todo: do your changes here
//
//        //don't change code below
//        val userStream: Flux<String> = messages.map { m -> m.user }
//        val payloadStream: Flux<String> = messages.map { m -> m.payload }
//        val metaData: CopyOnWriteArrayList<String> = CopyOnWriteArrayList()
//        val payload: CopyOnWriteArrayList<String> = CopyOnWriteArrayList()
...
//    @Test
//    fun hot_vs_cold() {
//        val updates: Flux<String> = systemUpdates() //todo: do your changes here
//
//        //subscriber 1
