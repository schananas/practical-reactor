...
//        val currentUserMono: Mono<String> = getCurrentUser()
//        getUserEmail(null)
//
...
//        //todo: feel free to change code as you need
//        autoComplete(null)
//        val suggestions: Flux<String> = userSearchInput() //todo: use one operator only
//
//        //don't change below this line
...
//    fun major_merger() {
//        //todo: feel free to change code as you need
//        val microsoftBlizzardCorp: Flux<String> = microsoftTitles()
//        blizzardTitles()
//
//        //don't change below this line
...
//    var sourceRef: AtomicReference<String> = AtomicReference("X")
//
...
//    fun deterministic() {
//        //don't change below this line
//        val source: Mono<String> = chooseSource()
//        sourceRef.set("A")
...
//
//        //todo: feel free to change code as you need
//        val stream: Flux<String> = StreamingConnection.startStreaming()
