...
//        //todo: feel free to change code as you need
//        val measurements: Flux<Integer>? = null
//        submitOperation {
//            val measures_readings: List<Integer> = get_measures_readings() //don't change this line
//        }
//
//        //don't change code below
//        StepVerifier.create(
...
//        val sink: Sinks.Many<Integer> = Sinks.many().multicast().onBackpressureBuffer()
//        val flux: Flux<Integer> = sink.asFlux()
//
//        //don't change code below
//        submitOperation {
...
//        val sub1: StepVerifier = StepVerifier.create(Flux.merge(flux.take(1)))
//            .expectNext(0x0800)
//            .expectComplete()
//            .verifyLater()
//
//        //subscriber2 subscribes, takes one element and cancels
//        val sub2: StepVerifier = StepVerifier.create(Flux.merge(flux.take(1)))
//            .expectNext(0x0800)
//            .expectComplete()
//            .verifyLater()
//
//        //subscriber3 subscribes after all previous subscribers have cancelled
//        val sub3: StepVerifier = StepVerifier.create(
//            flux.take(3)
//                .delaySubscription(Duration.ofSeconds(6))
//        )
...
//    fun emit_failure() {
//        //todo: feel free to change code as you need
//        val sink: Sinks.Many<Integer> = Sinks.many().replay().all()
//        for (i in 1..50) {
